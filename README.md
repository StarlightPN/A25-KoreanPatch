...
## ※ 주의사항 ※
### <p align="center">본 패치에서 사용하는 프로그램은 실행 중인 다른 프로그램의 요소를<br>읽고, 교체하는 프로그램입니다. 이에 따라, 본 페이지에서 제공되는 프로그램들의 사용으로 인해<br>원 서비스 제공자가 사용자를 제재할 수 있습니다.<br>이러한 상황이 발생한 경우 프로그램 사용자의 책임이며,<br>플러그인 및 패키지 제공자에는 책임이 없음을 명시합니다.</p>
